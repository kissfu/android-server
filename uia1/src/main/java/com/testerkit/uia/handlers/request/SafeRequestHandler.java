...
import com.testerkit.uia.exceptions.InvalidElementStateException;
import com.testerkit.uia.exceptions.InvalidSelectorException;
import com.testerkit.uia.exceptions.NoAlertOpenException;
...
public abstract class SafeRequestHandler extends BaseRequestHandler {
    ...
    @Override
    public final AppiumResponse handle(IRequest request) {
        try {
        ...
        } catch (UiSelectorSyntaxException e) { // | UiObjectNotFoundException
