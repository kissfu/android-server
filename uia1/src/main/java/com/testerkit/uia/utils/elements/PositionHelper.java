...
package com.testerkit.uia.utils.elements;
...
public abstract class PositionHelper {
    ...
    public static Point getAbsolutePosition(final Point point, final Rect displayRect,
                                            final Point offsets, final boolean shouldCheckBounds) throws InvalidCoordinatesException {
    ...
    public static Point getDeviceAbsPos(final Point point) throws InvalidCoordinatesException {
        ...
        final DeviceCore d = BaseContext.getInstance().getDevice();
        ScreenSize size = d.getScreenSize();
        final Rect displayRect = new Rect(0, 0, size.getWidth(), size.getHeight());
