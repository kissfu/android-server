...
public class UiAutomationElement extends UiElement<AccessibilityNodeInfo, UiAutomationElement> {
    ...
    public static UiAutomationElement rebuildForNewRoot(AccessibilityNodeInfo rawElement, List<CharSequence> toastMSGs) {
        cache.clear();
    ...
    private List<UiAutomationElement> buildChildren(AccessibilityNodeInfo node) {
        ...
        if (childCount == 0) {
            ...
            Object allowInvisibleElements = Session.capabilities.get(Settings.ALLOW_INVISIBLE_ELEMENTS.toString());
