...
public  class InteractionController1  extends InteractionController {
    ...
    public InteractionController1(Object interactionController) {
    ...
    protected String CLASS_INTERACTION_CONTROLLER() {
        return "com.android.uiautomator.core.InteractionController";
    }

    @Override
    public boolean injectEventSync(final InputEvent event) throws UIAException {
        return EventRegister1.runAndRegisterScrollEvents(new ReturningRunnable<Boolean>() {
            @Override
            public void run() {
