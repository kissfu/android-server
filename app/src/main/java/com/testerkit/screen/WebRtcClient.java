...
public class WebRtcClient {
    ...
    private final static String TAG = "UIA";
...
//            mListener.onAddRemoteStream(mediaStream, endPoint + 1);
        ...
        public void onBufferedAmountChange(long l) {
            Log.d(TAG, "onDataChannel onBufferedAmountChange:" + l);
        }
...
//        PeerConnectionFactory.InitializationOptions options = PeerConnectionFactory.InitializationOptions.builder(mContext).createInitializationOptions();
